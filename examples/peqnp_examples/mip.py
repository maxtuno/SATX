...
x0 = satx.linear(is_real=True)
x1 = satx.linear(is_real=True)
x2 = satx.linear(is_real=True)
x3 = satx.linear(is_real=True)
x4 = satx.linear(is_real=True)
x5 = satx.linear()
x6 = satx.linear()
x7 = satx.linear()
x8 = satx.linear()
...
assert x8 <= 23.0000
assert x9 <= 63.0000
print(satx.maximize(+0.0000 * x0 + 9.6856 * x1 + 0.0000 * x2 - 7.8267 * x3 - 3.4649 * x4 - 6.3391 * x5 - 3.6316 * x6 + 44.7655 * x7 + 3.7610 * x8 - 57.1083 * x9, lp_path='mip.lp'))
print(x0)
print(x1)
print(x2)
print(x3)
